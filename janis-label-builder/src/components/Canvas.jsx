...
function DropZone({ dragTypeRef, onAdd, compact }) {
  ...
  return (
    <div
      ref={ref}
      className="dropzone"
      style={compact ? { minHeight: 32, margin: 4 } : undefined}
...
export default function Canvas({ widgets, selId, sampleData, dragTypeRef, onAdd, onDelete, onMove, onSelect, onClear }) {
            ...
            : (
              <>
                {widgets.map((w, i) => (
                  ...
                  >
                    <WidgetRenderer widget={w} sampleData={sampleData} />
                    <div className="wov">
                      {i > 0 && (
